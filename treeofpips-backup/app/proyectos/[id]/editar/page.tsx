...
export default function EditProjectPage() {
  ...
  useEffect(() => {
    ...
    if (project) {
      setFormData({
        ...
        initialCapital: project.initialCapital.toString(),
        targetAmount: project.targetAmount.toString(),
        targetDate: project.targetDate,
        goalFrequency: project.goalFrequency || "daily",
        goalAmount: project.goalAmount?.toString() || "",
        type: project.type || "forex",
      })
    }
    setIsLoading(false)
  ...
  const handleSubmit = (e) => {
    ...
    // Calculate new total target and update project
    const updatedProject = {
      ...
      totalTarget: Number(formData.initialCapital) + Number(formData.targetAmount),
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-green-700">Editar Proyecto</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Información del Proyecto</CardTitle>
          <CardDescription>Actualiza los detalles de tu proyecto de trading</CardDescription>
        </CardHeader>
        <CardContent>
