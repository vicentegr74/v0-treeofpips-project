...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  // Verificar que config no sea null o undefined antes de usar Object.entries
  if (!config) {
    return null
  }

  const colorConfig = Object.entries(config || {}).filter(([_, itemConfig]) => {
    // Verificar que itemConfig no sea null o undefined
...
${colorConfig
  .map(([key, itemConfig]) => {
    // Verificar que itemConfig y sus propiedades no sean null o undefined
...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  Omit<React.ComponentProps<"div">, "payload" | "active" | "label"> & {
    active?: boolean
    payload?: Array<any>
    label?: any
    hideLabel?: boolean
